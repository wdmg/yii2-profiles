...
<div class="profiles-fields-view">
    <?= DetailView::widget([
        'model' => $model,
        'attributes' => [
            'id',
    ...
    <div>
        ...
        <?php if (Yii::$app->authManager && $this->context->module->moduleExist('rbac') && Yii::$app->user->can('updatePosts', [
            ...
            <div class="form-group pull-right">
                <?= Html::a(Yii::t('app/modules/profiles', 'Delete'), ['fields/delete', 'id' => $model->id], [
                ...
                <?= Html::a(Yii::t('app/modules/profiles', 'Update'), ['fields/update', 'id' => $model->id], ['class' => 'btn btn-edit btn-primary']) ?>
            </div>
        <?php endif; ?>
    </div>
</div>
