...
use Yii;
use wdmg\profiles\models\Fields;
use wdmg\profiles\models\FieldsSearch;
...
class FieldsController extends Controller
{
            ...
            if ($model->load(Yii::$app->request->post()) && $model->validate()) {
                ...
                if ($model->save()) {
                    ...
                    $this->module->logActivity(
                        'New custom field `' . $model->label . '` with ID `' . $model->id . '` has been successfully added.',
                    ...
                    Yii::$app->getSession()->setFlash(
                        'success',
                        Yii::t('app/modules/profiles', 'Custom field has been successfully added!')
                    );
                    ...
                    // Log activity
                    $this->module->logActivity(
                        'An error occurred while add the new custom field: ' . $model->label,
                        $this->uniqueId . ":" . $this->action->id,
                        'danger',
                        1
                    );
                    ...
                    Yii::$app->getSession()->setFlash(
                        'danger',
                        Yii::t('app/modules/profiles', 'An error occurred while add the custom field.')
                    );
                }
            }
        }
        ...
        if (Yii::$app->request->isAjax) {
            ...
            if ($model->load(Yii::$app->request->post()) && $model->validate()) {
                if ($model->save()) {
                    // Log activity
                    $this->module->logActivity(
                        'Custom field `' . $model->label . '` with ID `' . $model->id . '` has been successfully updated.',
                        $this->uniqueId . ":" . $this->action->id,
                        'success',
                        1
                    );
                    ...
                    Yii::$app->getSession()->setFlash(
                        ...
                        Yii::t(
                            'app/modules/profiles',
                            'OK! Custom field `{label}` successfully updated.',
                            [
                                'label' => $model->label
                            ]
                        )
                    ...
                    // Log activity
                    $this->module->logActivity(
                        'An error occurred while update the custom field `' . $model->label . '` with ID `' . $model->id . '`.',
                        $this->uniqueId . ":" . $this->action->id,
                        'danger',
                        1
                    );
                    ...
                    Yii::$app->getSession()->setFlash(
                        ...
                        Yii::t(
                            'app/modules/profiles',
                            'An error occurred while update a custom field `{label}`.',
                            [
                                'label' => $model->label
                            ]
                        )
    ...
    public function actionDelete($id)
    {
        ...
        if ($model->delete()) {
            // Log activity
            $this->module->logActivity(
                'Custom field `' . $model->label . '` with ID `' . $model->id . '` has been successfully deleted.',
                $this->uniqueId . ":" . $this->action->id,
                'success',
                1
            );
            ...
            Yii::$app->getSession()->setFlash(
                ...
                Yii::t(
                    'app/modules/profiles',
                    'OK! Custom field `{label}` successfully deleted.',
                    [
                        'label' => $model->label
                    ]
                )
            ...
            // Log activity
            $this->module->logActivity(
                'An error occurred while deleting the custom field `' . $model->label . '` with ID `' . $model->id . '`.',
                $this->uniqueId . ":" . $this->action->id,
                'danger',
                1
            );
            ...
            Yii::$app->getSession()->setFlash(
                ...
                Yii::t(
                    'app/modules/profiles',
                    'An error occurred while deleting a custom field `{label}`.',
                    [
                        'label' => $model->label
                    ]
                )
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException(Yii::t('app/modules/profiles', 'The requested custom field does not exist.'));
    }
